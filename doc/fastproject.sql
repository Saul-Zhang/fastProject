...
CREATE TABLE `def_permission` (
  ...
  `pid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '父节点id',
  `code` varchar(191) DEFAULT NULL COMMENT '权限标识',
...
-- Dump completed on 2023-05-04 18:40:17
