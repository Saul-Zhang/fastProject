...
CREATE TABLE `def_permission`  (
  ...
  `pid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父节点id',
...
-- ----------------------------
INSERT INTO `def_permission` VALUES ('10', '角色集合', '角色集合', '/RoleController/list', 0, '9', 'system:role:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('11', '角色添加', '角色添加', '/RoleController/add', 0, '9', 'system:role:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('12', '角色删除', '角色删除', '/RoleController/remove', 0, '9', 'system:role:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('13', '角色修改', '角色修改', '/RoleController/edit', 0, '9', 'system:role:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('14', '权限展示', '权限展示', '/PermissionController/view', 0, '411522822607867904', 'system:permission:view', 1, 'fa fa-key', 3, 0);
INSERT INTO `def_permission` VALUES ('15', '权限集合', '权限集合', '/PermissionController/list', 0, '14', 'system:permission:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('16', '权限添加', '权限添加', '/permissionController/add', 0, '14', 'system:permission:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('17', '权限删除', '权限删除', '/PermissionController/remove', 0, '14', 'system:permission:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('18', '权限修改', '权限修改', '/PermissionController/edit', 0, '14', 'system:permission:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('19', '文件管理', '文件管理', '/FileController/view', 0, '592059865673760768', 'system:file:view', 1, 'fa fa-file-image-o', 4, 0);
INSERT INTO `def_permission` VALUES ('20', '文件添加', '文件添加', '/FileController/add', 0, '19', 'system:file:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('21', '文件删除', '文件删除', '/FileController/remove', 0, '19', 'system:file:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('22', '文件修改', '文件修改', '/FileController/edit', 0, '19', 'system:file:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('23', '文件集合', '文件集合', '/FileController/list', 0, '19', 'system:file:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('330365026642825216', '公告管理', '公告展示', '/SysNoticeController/view', 0, '592059865673760768', 'gen:sysNotice:view', 1, 'fa fa-telegram', 10, 0);
INSERT INTO `def_permission` VALUES ('3303650266428252171', '公告集合', '公告集合', '/SysNoticeController/list', 0, '330365026642825216', 'gen:sysNotice:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3303650266428252182', '公告添加', '公告添加', '/SysNoticeController/add', 0, '330365026642825216', 'gen:sysNotice:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('3303650266428252193', '公告删除', '公告删除', '/SysNoticeController/remove', 0, '330365026642825216', 'gen:sysNotice:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('3303650266428252204', '公告修改', '公告修改', '/SysNoticeController/edit', 0, '330365026642825216', 'gen:sysNotice:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('331778807298134016', '定时器表达式', NULL, 'https://www.bejson.com/othertools/cron/', 1, '617766548966211584', '#', 1, 'layui-icon fa fa-flash', 12, 0);
INSERT INTO `def_permission` VALUES ('332157860920299520', '定时任务', '定时任务调度表展示', '/SysQuartzJobController/view', 0, '592059865673760768', 'gen:sysQuartzJob:view', 1, 'fa fa-hourglass-1', 13, 0);
INSERT INTO `def_permission` VALUES ('3321578609202995211', '定时任务调度表集合', '定时任务调度表集合', '/SysQuartzJobController/list', 0, '332157860920299520', 'gen:sysQuartzJob:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3321578609202995222', '定时任务调度表添加', '定时任务调度表添加', '/SysQuartzJobController/add', 0, '332157860920299520', 'gen:sysQuartzJob:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('3321578609202995233', '定时任务调度表删除', '定时任务调度表删除', '/SysQuartzJobController/remove', 0, '332157860920299520', 'gen:sysQuartzJob:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('3321578609202995244', '定时任务调度表修改', '定时任务调度表修改', '/SysQuartzJobController/edit', 0, '332157860920299520', 'gen:sysQuartzJob:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('332857281479839744', '定时任务日志', '定时任务日志', '/SysQuartzJobLogController/view', 0, '592059865673760768', 'gen:sysQuartzJobLog:view', 1, 'fa fa-database', 14, 0);
INSERT INTO `def_permission` VALUES ('3328572814798397451', '定时任务调度日志表集合', '定时任务调度日志表集合', '/SysQuartzJobLogController/list', 0, '332857281479839744', 'gen:sysQuartzJobLog:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3328572814798397473', '定时任务调度日志表删除', '定时任务调度日志表删除', '/SysQuartzJobLogController/remove', 0, '332857281479839744', 'gen:sysQuartzJobLog:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('335330315113467904', 'Json工具', NULL, 'https://www.bejson.com/jsonviewernew/', 1, '617766548966211584', '#', 1, 'layui-icon fa fa-retweet', 10, 0);
INSERT INTO `def_permission` VALUES ('340067579836108800', '省份管理', NULL, '', 0, '0', '', 0, 'layui-icon layui-icon layui-icon-website', 4, 0);
INSERT INTO `def_permission` VALUES ('340068151804956672', '省份表管理', '省份表展示', '/SysProvinceController/view', 0, '340067579836108800', 'gen:sysProvince:view', 1, 'fa fa-quora', 2, 0);
INSERT INTO `def_permission` VALUES ('3400681518049566731', '省份表集合', '省份表集合', '/SysProvinceController/list', 0, '340068151804956672', 'gen:sysProvince:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400681518049566742', '省份表添加', '省份表添加', '/SysProvinceController/add', 0, '340068151804956672', 'gen:sysProvince:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400681518049566753', '省份表删除', '省份表删除', '/SysProvinceController/remove', 0, '340068151804956672', 'gen:sysProvince:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400681518049566764', '省份表修改', '省份表修改', '/SysProvinceController/edit', 0, '340068151804956672', 'gen:sysProvince:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('340088022018166784', '城市表管理', '城市设置展示', '/SysCityController/view', 0, '340067579836108800', 'gen:sysCity:view', 1, 'fa fa-quora', 3, 0);
INSERT INTO `def_permission` VALUES ('3400880220181667851', '城市设置集合', '城市设置集合', '/SysCityController/list', 0, '340088022018166784', 'gen:sysCity:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400880220181667862', '城市设置添加', '城市设置添加', '/SysCityController/add', 0, '340088022018166784', 'gen:sysCity:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400880220181667873', '城市设置删除', '城市设置删除', '/SysCityController/remove', 0, '340088022018166784', 'gen:sysCity:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400880220181667884', '城市设置修改', '城市设置修改', '/SysCityController/edit', 0, '340088022018166784', 'gen:sysCity:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('340096183135506432', '地区设置管理', '地区设置展示', '/SysAreaController/view', 0, '340067579836108800', 'gen:sysArea:view', 1, 'fa fa-quora', 4, 0);
INSERT INTO `def_permission` VALUES ('3400961831355064331', '地区设置集合', '地区设置集合', '/SysAreaController/list', 0, '340096183135506432', 'gen:sysArea:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400961831355064342', '地区设置添加', '地区设置添加', '/SysAreaController/add', 0, '340096183135506432', 'gen:sysArea:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400961831355064353', '地区设置删除', '地区设置删除', '/SysAreaController/remove', 0, '340096183135506432', 'gen:sysArea:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('3400961831355064364', '地区设置修改', '地区设置修改', '/SysAreaController/edit', 0, '340096183135506432', 'gen:sysArea:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('340127412270534656', '街道设置管理', '街道设置展示', '/SysStreetController/view', 0, '340067579836108800', 'gen:sysStreet:view', 1, 'fa fa-quora', 5, 0);
INSERT INTO `def_permission` VALUES ('3401274122705346571', '街道设置集合', '街道设置集合', '/SysStreetController/list', 0, '340127412270534656', 'gen:sysStreet:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3401274122705346582', '街道设置添加', '街道设置添加', '/SysStreetController/add', 0, '340127412270534656', 'gen:sysStreet:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('3401274122705346593', '街道设置删除', '街道设置删除', '/SysStreetController/remove', 0, '340127412270534656', 'gen:sysStreet:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('3401274122705346604', '街道设置修改', '街道设置修改', '/SysStreetController/edit', 0, '340127412270534656', 'gen:sysStreet:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('340301160042860544', '省份联动', '省份联动', '/ProvinceLinkageController/view', 0, '340067579836108800', '#', 1, 'fa fa-etsy', 1, 0);
INSERT INTO `def_permission` VALUES ('340381240911859712', 'JavaScript格式化', NULL, '/static/tool/htmlformat/javascriptFormat.html', 0, '617766548966211584', '#', 1, 'layui-icon layui-icon fa fa-magic', 11, 0);
INSERT INTO `def_permission` VALUES ('373489907429150720', 'URL拦截管理', '拦截url表展示', '/SysInterUrlController/view', 0, '617766548966211584', 'gen:sysInterUrl:view', 1, 'fa fa-hand-stop-o', 16, 0);
INSERT INTO `def_permission` VALUES ('3734899074291507211', '拦截url表集合', '拦截url表集合', '/SysInterUrlController/list', 0, '373489907429150720', 'gen:sysInterUrl:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('3734899074291507222', '拦截url表添加', '拦截url表添加', '/SysInterUrlController/add', 0, '373489907429150720', 'gen:sysInterUrl:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('3734899074291507233', '拦截url表删除', '拦截url表删除', '/SysInterUrlController/remove', 0, '373489907429150720', 'gen:sysInterUrl:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('3734899074291507244', '拦截url表修改', '拦截url表修改', '/SysInterUrlController/edit', 0, '373489907429150720', 'gen:sysInterUrl:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('4', '用户管理', '用户展示', '/UserController/view', 0, '411522822607867904', 'system:user:view', 1, 'icon icon-user', 1, 0);
INSERT INTO `def_permission` VALUES ('410791701859405824', '岗位管理', '岗位展示', '/SysPositionController/view', 0, '411522822607867904', 'gen:sysPosition:view', 1, 'fa fa-vcard', 17, 0);
INSERT INTO `def_permission` VALUES ('4107917018594058251', '岗位表集合', '岗位集合', '/SysPositionController/list', 0, '410791701859405824', 'gen:sysPosition:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('4107917018594058262', '岗位表添加', '岗位添加', '/SysPositionController/add', 0, '410791701859405824', 'gen:sysPosition:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('4107917018594058273', '岗位表删除', '岗位删除', '/SysPositionController/remove', 0, '410791701859405824', 'gen:sysPosition:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('4107917018594058284', '岗位表修改', '岗位修改', '/SysPositionController/edit', 0, '410791701859405824', 'gen:sysPosition:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('410989805699207168', '部门管理', '部门展示', '/SysDepartmentController/view', 0, '411522822607867904', 'gen:sysDepartment:view', 1, 'fa fa-odnoklassniki', 18, 0);
INSERT INTO `def_permission` VALUES ('4109898056992071691', '部门集合', '部门集合', '/SysDepartmentController/list', 0, '410989805699207168', 'gen:sysDepartment:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('4109898056992071702', '部门添加', '部门添加', '/SysDepartmentController/add', 0, '410989805699207168', 'gen:sysDepartment:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('4109898056992071713', '部门删除', '部门删除', '/SysDepartmentController/remove', 0, '410989805699207168', 'gen:sysDepartment:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('4109898056992071724', '部门修改', '部门修改', '/SysDepartmentController/edit', 0, '410989805699207168', 'gen:sysDepartment:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('411522822607867904', '用户管理', NULL, '', 0, '0', '', 0, 'layui-icon layui-icon-user', 3, 0);
INSERT INTO `def_permission` VALUES ('486690002869157888', '用户密码修改', '用户密码修改', '/UserController/editPwd', 0, '4', 'system:user:editPwd', 2, 'entypo-tools', 3, 0);
INSERT INTO `def_permission` VALUES ('496126970468237312', '日志展示', '日志管理', '/LogController/view', 0, '592059865673760768', 'system:log:view', 1, 'fa fa-info', 9, 0);
INSERT INTO `def_permission` VALUES ('496127240363311104', '日志删除', '日志删除', '/LogController/remove', 0, '496126970468237312', 'system:log:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('496127794879660032', '日志集合', '日志集合', '/LogController/list', 0, '496126970468237312', 'system:log:list', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('5', '用户集合', '用户集合', '/UserController/list', 0, '4', 'system:user:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('581541547099553792', 'druid监控', 'druid监控', '/druid/', 0, '617766548966211584', 'user:list', 1, 'fa fa-line-chart', 6, 0);
INSERT INTO `def_permission` VALUES ('583063272123531264', 'API文档', NULL, '/doc.html', 1, '617766548966211584', '--', 1, 'layui-icon fa fa-font', 8, 0);
INSERT INTO `def_permission` VALUES ('586003694080753664', '表单构建', NULL, '/static/component/code/index.html', 0, '617766548966211584', 'system:tool:view', 1, 'layui-icon layui-icon fa fa-list-alt', 5, 0);
INSERT INTO `def_permission` VALUES ('587453033487532032', '后台模板', NULL, 'https://www.layui.com/doc/', 1, '617766548966211584', '', 1, 'layui-icon layui-icon fa fa-telegram', 9, 0);
INSERT INTO `def_permission` VALUES ('589559748521623552', '一级菜单', NULL, '', 0, '0', '', 0, 'layui-icon layui-icon layui-icon layui-icon-face-smile', 6, 0);
INSERT INTO `def_permission` VALUES ('592059865673760768', '系统管理', NULL, '', 0, '0', '', 0, 'layui-icon layui-icon-home', 1, 0);
INSERT INTO `def_permission` VALUES ('592067570522128384', '测试跳转', '测试跳转', 'http://www.baidu.com', 1, '589559748521623552', '#', 1, 'fa fa-address-book', NULL, 0);
INSERT INTO `def_permission` VALUES ('592167738407911424', '系统监控', '系统监控', '/ServiceController/view', 0, '617766548966211584', 'system:service:view', 1, 'fa fa-video-camera', 7, 0);
INSERT INTO `def_permission` VALUES ('594691026430459904', '电子邮件管理', '电子邮件展示', '/EmailController/view', 0, '592059865673760768', 'system:email:view', 1, 'fa fa-envelope', 8, 0);
INSERT INTO `def_permission` VALUES ('5946910264304599041', '电子邮件集合', '电子邮件集合', '/EmailController/list', 0, '594691026430459904', 'system:email:list', 2, '', NULL, 0);
INSERT INTO `def_permission` VALUES ('5946910264304599042', '电子邮件添加', '电子邮件添加', '/EmailController/add', 0, '594691026430459904', 'system:email:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('5946910264304599043', '电子邮件删除', '电子邮件删除', '/EmailController/remove', 0, '594691026430459904', 'system:email:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('5946910264304599044', '电子邮件修改', '电子邮件修改', '/EmailController/edit', 0, '594691026430459904', 'system:email:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('6', '用户添加', '用户添加', '/UserController/add', 0, '4', 'system:user:add', 2, 'entypo-plus-squared', NULL, 0);
INSERT INTO `def_permission` VALUES ('610635485890478080', '代码生成', NULL, '', 0, '0', '', 0, 'layui-icon layui-icon layui-icon layui-icon-praise', 2, 0);
INSERT INTO `def_permission` VALUES ('610635950447394816', '全局配置', '', '/autoCodeController/global', 0, '610635485890478080', 'system:autocode:global', 1, 'fa fa-university', NULL, 0);
INSERT INTO `def_permission` VALUES ('617766548966211584', '系统工具', NULL, '', 0, '0', '', 0, 'layui-icon layui-icon layui-icon layui-icon layui-icon layui-icon layui-icon-util', 5, 0);
INSERT INTO `def_permission` VALUES ('618918631769636864', '字典管理', '字典类型表展示', '/DictTypeController/view', 0, '592059865673760768', 'system:dictType:view', 1, 'fa fa-puzzle-piece', 11, 0);
INSERT INTO `def_permission` VALUES ('6189186317738311681', '字典类型表集合', '字典类型表集合', '/DictTypeController/list', 0, '618918631769636864', 'system:dictType:list', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('6189186317948026882', '字典类型表添加', '字典类型表添加', '/DictTypeController/add', 0, '618918631769636864', 'system:dictType:add', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('6189186317948026883', '字典类型表删除', '字典类型表删除', '/DictTypeController/remove', 0, '618918631769636864', 'system:dictType:remove', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('6189186317989969924', '字典类型表修改', '字典类型表修改', '/DictTypeController/edit', 0, '618918631769636864', 'system:dictType:edit', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('6192095214866268161', '字典数据表集合', '字典数据表集合', '/DictDataController/list', 0, '618918631769636864', 'system:dictData:list', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('6192095214866268162', '字典数据表添加', '字典数据表添加', '/DictDataController/add', 0, '618918631769636864', 'system:dictData:add', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('6192095215075983363', '字典数据表删除', '字典数据表删除', '/DictDataController/remove', 0, '618918631769636864', 'system:dictData:remove', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('6192095215075983364', '字典数据表修改', '字典数据表修改', '/DictDataController/edit', 0, '618918631769636864', 'system:dictData:edit', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('619836559427895296', '字典数据视图', '字典数据视图', '/DictDataController/view', 0, '618918631769636864', 'system:dictData:view', 2, NULL, NULL, 0);
INSERT INTO `def_permission` VALUES ('7', '用户删除', '用户删除', '/UserController/remove', 0, '4', 'system:user:remove', 2, 'entypo-trash', NULL, 0);
INSERT INTO `def_permission` VALUES ('8', '用户修改', '用户修改', '/UserController/edit', 0, '4', 'system:user:edit', 2, 'fa fa-wrench', NULL, 0);
INSERT INTO `def_permission` VALUES ('9', '角色管理', '角色展示', '/RoleController/view', 0, '411522822607867904', 'system:role:view', 1, 'fa fa-group', 2, 0);
...
-- Records of def_role
-- ----------------------------
INSERT INTO `def_role` VALUES ('24', '用户');
INSERT INTO `def_role` VALUES ('4', '能修改用户密码角色');
INSERT INTO `def_role` VALUES ('60', '管理员');
...
-- ----------------------------
INSERT INTO `rel_permission_role` VALUES ('10', '60', '10');
INSERT INTO `rel_permission_role` VALUES ('11', '60', '11');
INSERT INTO `rel_permission_role` VALUES ('12', '60', '12');
INSERT INTO `rel_permission_role` VALUES ('13', '60', '13');
INSERT INTO `rel_permission_role` VALUES ('14', '60', '14');
INSERT INTO `rel_permission_role` VALUES ('15', '60', '15');
INSERT INTO `rel_permission_role` VALUES ('16', '60', '16');
INSERT INTO `rel_permission_role` VALUES ('17', '60', '17');
INSERT INTO `rel_permission_role` VALUES ('18', '60', '18');
INSERT INTO `rel_permission_role` VALUES ('19', '60', '19');
INSERT INTO `rel_permission_role` VALUES ('20', '60', '20');
INSERT INTO `rel_permission_role` VALUES ('21', '60', '21');
INSERT INTO `rel_permission_role` VALUES ('22', '60', '22');
INSERT INTO `rel_permission_role` VALUES ('23', '60', '23');
INSERT INTO `rel_permission_role` VALUES ('330365026642825216', '60', '330365026642825216');
INSERT INTO `rel_permission_role` VALUES ('3303650266428252171', '60', '3303650266428252171');
INSERT INTO `rel_permission_role` VALUES ('3303650266428252182', '60', '3303650266428252182');
INSERT INTO `rel_permission_role` VALUES ('3303650266428252193', '60', '3303650266428252193');
INSERT INTO `rel_permission_role` VALUES ('3303650266428252204', '60', '3303650266428252204');
INSERT INTO `rel_permission_role` VALUES ('331778807298134016', '60', '331778807298134016');
INSERT INTO `rel_permission_role` VALUES ('332157860920299520', '60', '332157860920299520');
INSERT INTO `rel_permission_role` VALUES ('3321578609202995211', '60', '3321578609202995211');
INSERT INTO `rel_permission_role` VALUES ('3321578609202995222', '60', '3321578609202995222');
INSERT INTO `rel_permission_role` VALUES ('3321578609202995233', '60', '3321578609202995233');
INSERT INTO `rel_permission_role` VALUES ('3321578609202995244', '60', '3321578609202995244');
INSERT INTO `rel_permission_role` VALUES ('332857281479839744', '60', '332857281479839744');
INSERT INTO `rel_permission_role` VALUES ('3328572814798397451', '60', '3328572814798397451');
INSERT INTO `rel_permission_role` VALUES ('3328572814798397473', '60', '3328572814798397473');
INSERT INTO `rel_permission_role` VALUES ('335330315113467904', '60', '335330315113467904');
INSERT INTO `rel_permission_role` VALUES ('340067579836108800', '60', '340067579836108800');
INSERT INTO `rel_permission_role` VALUES ('340068151804956672', '60', '340068151804956672');
INSERT INTO `rel_permission_role` VALUES ('3400681518049566731', '60', '3400681518049566731');
INSERT INTO `rel_permission_role` VALUES ('3400681518049566742', '60', '3400681518049566742');
INSERT INTO `rel_permission_role` VALUES ('3400681518049566753', '60', '3400681518049566753');
INSERT INTO `rel_permission_role` VALUES ('3400681518049566764', '60', '3400681518049566764');
INSERT INTO `rel_permission_role` VALUES ('340088022018166784', '60', '340088022018166784');
INSERT INTO `rel_permission_role` VALUES ('3400880220181667851', '60', '3400880220181667851');
INSERT INTO `rel_permission_role` VALUES ('3400880220181667862', '60', '3400880220181667862');
INSERT INTO `rel_permission_role` VALUES ('3400880220181667873', '60', '3400880220181667873');
INSERT INTO `rel_permission_role` VALUES ('3400880220181667884', '60', '3400880220181667884');
INSERT INTO `rel_permission_role` VALUES ('340096183135506432', '60', '340096183135506432');
INSERT INTO `rel_permission_role` VALUES ('3400961831355064331', '60', '3400961831355064331');
INSERT INTO `rel_permission_role` VALUES ('3400961831355064342', '60', '3400961831355064342');
INSERT INTO `rel_permission_role` VALUES ('3400961831355064353', '60', '3400961831355064353');
INSERT INTO `rel_permission_role` VALUES ('3400961831355064364', '60', '3400961831355064364');
INSERT INTO `rel_permission_role` VALUES ('340127412270534656', '60', '340127412270534656');
INSERT INTO `rel_permission_role` VALUES ('3401274122705346571', '60', '3401274122705346571');
INSERT INTO `rel_permission_role` VALUES ('3401274122705346582', '60', '3401274122705346582');
INSERT INTO `rel_permission_role` VALUES ('3401274122705346593', '60', '3401274122705346593');
INSERT INTO `rel_permission_role` VALUES ('3401274122705346604', '60', '3401274122705346604');
INSERT INTO `rel_permission_role` VALUES ('340301160042860544', '60', '340301160042860544');
INSERT INTO `rel_permission_role` VALUES ('340381240911859712', '60', '340381240911859712');
INSERT INTO `rel_permission_role` VALUES ('373489907429150720', '60', '373489907429150720');
INSERT INTO `rel_permission_role` VALUES ('3734899074291507211', '60', '3734899074291507211');
INSERT INTO `rel_permission_role` VALUES ('3734899074291507222', '60', '3734899074291507222');
INSERT INTO `rel_permission_role` VALUES ('3734899074291507233', '60', '3734899074291507233');
INSERT INTO `rel_permission_role` VALUES ('3734899074291507244', '60', '3734899074291507244');
INSERT INTO `rel_permission_role` VALUES ('4', '60', '4');
INSERT INTO `rel_permission_role` VALUES ('410791701859405824', '60', '410791701859405824');
INSERT INTO `rel_permission_role` VALUES ('4107917018594058251', '60', '4107917018594058251');
INSERT INTO `rel_permission_role` VALUES ('4107917018594058262', '60', '4107917018594058262');
INSERT INTO `rel_permission_role` VALUES ('4107917018594058273', '60', '4107917018594058273');
INSERT INTO `rel_permission_role` VALUES ('4107917018594058284', '60', '4107917018594058284');
INSERT INTO `rel_permission_role` VALUES ('410989805699207168', '60', '410989805699207168');
INSERT INTO `rel_permission_role` VALUES ('4109898056992071691', '60', '4109898056992071691');
INSERT INTO `rel_permission_role` VALUES ('4109898056992071702', '60', '4109898056992071702');
INSERT INTO `rel_permission_role` VALUES ('4109898056992071713', '60', '4109898056992071713');
INSERT INTO `rel_permission_role` VALUES ('4109898056992071724', '60', '4109898056992071724');
INSERT INTO `rel_permission_role` VALUES ('411522822607867904', '60', '411522822607867904');
INSERT INTO `rel_permission_role` VALUES ('486690002869157888', '60', '486690002869157888');
INSERT INTO `rel_permission_role` VALUES ('496126970468237312', '60', '496126970468237312');
INSERT INTO `rel_permission_role` VALUES ('496127240363311104', '60', '496127240363311104');
INSERT INTO `rel_permission_role` VALUES ('496127794879660032', '60', '496127794879660032');
INSERT INTO `rel_permission_role` VALUES ('5', '60', '5');
INSERT INTO `rel_permission_role` VALUES ('581541547099553792', '60', '581541547099553792');
INSERT INTO `rel_permission_role` VALUES ('583063272123531264', '60', '583063272123531264');
INSERT INTO `rel_permission_role` VALUES ('586003694080753664', '60', '586003694080753664');
INSERT INTO `rel_permission_role` VALUES ('587453033487532032', '60', '587453033487532032');
INSERT INTO `rel_permission_role` VALUES ('589559748521623552', '60', '589559748521623552');
INSERT INTO `rel_permission_role` VALUES ('592059865673760768', '60', '592059865673760768');
INSERT INTO `rel_permission_role` VALUES ('592067570522128384', '60', '592067570522128384');
INSERT INTO `rel_permission_role` VALUES ('592167738407911424', '60', '592167738407911424');
INSERT INTO `rel_permission_role` VALUES ('594691026430459904', '60', '594691026430459904');
INSERT INTO `rel_permission_role` VALUES ('5946910264304599041', '60', '5946910264304599041');
INSERT INTO `rel_permission_role` VALUES ('5946910264304599042', '60', '5946910264304599042');
INSERT INTO `rel_permission_role` VALUES ('5946910264304599043', '60', '5946910264304599043');
INSERT INTO `rel_permission_role` VALUES ('5946910264304599044', '60', '5946910264304599044');
INSERT INTO `rel_permission_role` VALUES ('6', '60', '6');
INSERT INTO `rel_permission_role` VALUES ('610635485890478080', '60', '610635485890478080');
INSERT INTO `rel_permission_role` VALUES ('610635950447394816', '60', '610635950447394816');
INSERT INTO `rel_permission_role` VALUES ('617766548966211584', '60', '617766548966211584');
INSERT INTO `rel_permission_role` VALUES ('618918631769636864', '60', '618918631769636864');
INSERT INTO `rel_permission_role` VALUES ('6189186317738311681', '60', '6189186317738311681');
INSERT INTO `rel_permission_role` VALUES ('6189186317948026882', '60', '6189186317948026882');
INSERT INTO `rel_permission_role` VALUES ('6189186317948026883', '60', '6189186317948026883');
INSERT INTO `rel_permission_role` VALUES ('6189186317989969924', '60', '6189186317989969924');
INSERT INTO `rel_permission_role` VALUES ('6192095214866268161', '60', '6192095214866268161');
INSERT INTO `rel_permission_role` VALUES ('6192095214866268162', '60', '6192095214866268162');
INSERT INTO `rel_permission_role` VALUES ('6192095215075983363', '60', '6192095215075983363');
INSERT INTO `rel_permission_role` VALUES ('6192095215075983364', '60', '6192095215075983364');
INSERT INTO `rel_permission_role` VALUES ('619836559427895296', '60', '619836559427895296');
INSERT INTO `rel_permission_role` VALUES ('7', '60', '7');
INSERT INTO `rel_permission_role` VALUES ('8', '60', '8');
INSERT INTO `rel_permission_role` VALUES ('9', '60', '9');
