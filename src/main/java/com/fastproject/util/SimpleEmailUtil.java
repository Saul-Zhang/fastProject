...
public class SimpleEmailUtil {
	...
	public static void sendEmail(TSysEmail tSysEmail) throws Exception {
		FastProperties fastProperties = SpringUtils.getBean(FastProperties.class);
		// 这个类主要是设置邮件
		MailSenderInfo mailInfo = new MailSenderInfo();
		mailInfo.setMailServerHost(fastProperties.getEmailSmtp());
		mailInfo.setMailServerPort(fastProperties.getEmailPort());
		mailInfo.setValidate(true);
		mailInfo.setSsl(true);
		mailInfo.setUserName(fastProperties.getEmailAccount());
		mailInfo.setPassword(fastProperties.getEmailPassword());// 您的邮箱密码
