...
//      com.fastproject.model.auto.SysNoticeExample.Criteria criteria1 = testExample.createCriteria();
//      if (name != null && !"".equals(name)) {
...
//        new LambdaQueryWrapperX<Notice>().orderByDesc(Notice::getId).limitN(8));
//  }
